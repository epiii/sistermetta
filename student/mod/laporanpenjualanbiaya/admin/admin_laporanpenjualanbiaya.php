...
if($_GET['aksi']==""){
$admin .='<div class="panel-heading"><b>Laporan Transaksi Biaya</b></div>';
$tglawal = date("Y-m-01");
$tglnow = date("Y-m-d");
$tglmulai 		= !isset($tglmulai) ? $tglnow : $tglmulai;
$tglakhir 		= !isset($tglakhir) ? $tglnow : $tglakhir;
$admin .= '<form class="form-inline" method="get" action="cetakpenjualanbiaya.php" enctype ="multipart/form-data" id="posts" target="_blank">
...
$admin .='<div class="panel-heading"><b>Laporan Detail Transaksi Biaya</b></div>';
$admin .= '<form class="form-inline" method="get" action="cetakpenjualanbiaya.php" enctype ="multipart/form-data" id="posts" target="_blank">
<table class="table table-striped table-hover">';
$admin .= '
	<tr>
