<?php
	...
	$totala =  $koneksi_db->sql_query( "SELECT * FROM hrd_karyawan where status='3'" );
	$jumlaha = $koneksi_db->sql_numrows( $totala );
     $totala2 =  $koneksi_db->sql_query( "SELECT * FROM hrd_karyawan where status='4'" );
	$jumlaha2 = $koneksi_db->sql_numrows( $totala2 );
     $totala3 =  $koneksi_db->sql_query( "SELECT * FROM hrd_karyawan where status='5'" );
	$jumlaha3 = $koneksi_db->sql_numrows( $totala3 );
     $totala4 =  $koneksi_db->sql_query( "SELECT * FROM hrd_karyawan where status='6'" );
	$dataSet2->addPoint(new Point("Tetap ($jumlaha)", $jumlaha));
	$dataSet2->addPoint(new Point("Honorer ($jumlaha2)", $jumlaha2));
	$dataSet2->addPoint(new Point("Kontrak ($jumlaha3)", $jumlaha3));
	$dataSet2->addPoint(new Point("Magang ($jumlaha4)", $jumlaha4));
