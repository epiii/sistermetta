...
--
-- Host: 127.0.0.1
-- Generation Time: 01 Des 2015 pada 05.35
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
(1186, 1, 12, 10000, 4146875),
(1187, 2, 3, 10000, 10000),
(1188, 2, 5, 10000, 10000),
(1189, 2, 12, 10000, 10000),
...
--
ALTER TABLE `keu_jurnal`
MODIFY `replid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=217;
--
...
--
ALTER TABLE `keu_penerimaansiswa`
MODIFY `replid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `keu_transaksi`
MODIFY `replid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=145;
--
