...
INSERT INTO `pos_alur_stok` VALUES (88,'2015-07-02','stok awal','-','001','60'),(89,'2015-07-02','stok awal','-','002','77'),(90,'2015-07-02','stok awal','-','003','44'),(91,'2015-07-02','stok awal','-','004','77'),(92,'2015-07-02','stok awal','-','005','40'),(93,'2015-07-02','stok awal','-','006','60'),(94,'2015-07-02','stok awal','-','007','33'),(95,'2015-07-02','stok awal','-','008','5'),(98,'2015-07-02','stok awal','-','BK001','55'),(100,'2015-07-02','Penjualan','FAK0207150001','008','2'),(101,'2015-07-02','Penjualan','FAK0207150002','BK001','1'),(102,'2015-07-07','Stok Awal','-','P 1 BI Gemar Berbahasa Indonesia 1A  ERLANGGA PD P','98'),(103,'2015-07-07','Pembelian','INV0707150002','P 1 BI Gemar Berbahasa Indonesia 1A  ERLANGGA PD P','8'),(104,'2015-07-07','stok awal','-','P 1 BI Gemar Berbahasa Indonesia 1A  ERLANGGA PD P','98'),(105,'2015-07-07','stok awal','-','P 1 BI Gemar Berbahasa Indonesia 1A  ERLANGGA PD P','98'),(106,'2015-07-07','Stok Awal','-','P 1 BI Gemar Berbahasa Indonesia 1A  ERLANGGA PD P','98');
...
INSERT INTO `pos_biayabulanan` VALUES (1,'2015-07-01','LISTRIK','500000'),(2,'2015-07-01','AIR','50000');

#
# Structure for table "pos_bulan"
#
...
#
# Data for table "pos_bulan"
#

INSERT INTO `pos_bulan` VALUES (1,'Januari','01'),(2,'Februari','02'),(3,'Maret','03'),(4,'April','04'),(5,'Mei','05'),(6,'Juni','06'),(7,'Juli','07'),(8,'Agustus','08'),(9,'September','09'),(10,'Oktober','10'),(11,'Nopember','11'),(12,'Desember','12');
...
#
# Structure for table "pos_jenisjasa"
#
...
INSERT INTO `pos_jenisproduk` VALUES (1,'SERAGAM','BARANG'),(3,'BUKU','BARANG'),(7,'FORMULIR PSIKOTEST','BARANG'),(9,'FOOD BEVERAGES','BARANG'),(10,'EKSTRAKURIKULER','JASA');
...
INSERT INTO `pos_jenjang` VALUES (1,'Play Group A'),(5,'Tidak Ada'),(6,'Primary 1'),(7,'Primary 2'),(8,'Primary 3'),(9,'Primary 4'),(10,'Primary 5'),(11,'Primary 6'),(12,'Secondary 1'),(13,'Secondary 2'),(14,'Secondary 3'),(15,'Secondary 4'),(16,'High School 11'),(17,'High School 12'),(18,'Play Group B'),(19,'Kindergarten A'),(20,'Kindergarten B');
...
INSERT INTO `pos_pembelian` VALUES (1,'INV0207150001','PO0207150001','2015-07-02','SUP0019','Hutang','635000','0','635000','635000','0','30','2015-08-1','admin'),(2,'INV0707150002','PO0707150004','2015-07-07','SUP0019','Hutang','159120','0','159120','0','159120','','1970-01-1','admin');
...
INSERT INTO `pos_pembeliandetail` VALUES (1,'INV0207150001','PO0207150001','002','5','127000','0','635000'),(2,'INV0707150002','PO0707150004','P 1 BI Gemar Berbahasa Indonesia 1A  ERLANGGA PD P','8','22100','10','159120');
...
INSERT INTO `pos_penjualan` VALUES (1,'FAK0207150001','POF0207150001','2015-07-02','1005','Tunai','110000','0','110000','110000','0','0','2015-07-2','admin'),(2,'FAK0207150002','POF0207150002','2015-07-02','1005','Tunai','30000','0','30000','30000','0','0','2015-07-2','admin');
...
INSERT INTO `pos_penjualanbiaya` VALUES (1,'FKB0207150001','2015-07-02','Tunai','1000','0','1000','1000','admin'),(2,'FKB0207150002','2015-07-02','Tunai','7000','0','7000','7000','admin');
...
INSERT INTO `pos_penjualanbiayadetail` VALUES (1,'FKB0207150001','BTRP01',3,'1','1000','0','0','1000'),(2,'FKB0207150002','GURU PRAMUKA',6,'1','7000','0','0','7000');
...
INSERT INTO `pos_penjualandetail` VALUES (1,'FAK0207150001','POF0207150001','1','008','2','55000','50000','0','110000'),(2,'FAK0207150002','POF0207150002','3','BK001','1','30000','25000','0','30000');
...
INSERT INTO `pos_penjualanjasadetail` VALUES (1,'FKJ0207150001','10',6,'4','10000','0','0','40000'),(2,'FKJ0207150001','2',6,'4','5000','0','0','20000');
...
INSERT INTO `pos_po` VALUES (1,'PO0207150001','2015-07-02','SUP0019','Hutang','635000','0','0','30','admin'),(2,'PO0707150002','2015-07-07','SUP111','Tunai','2165800','0','0','0','admin'),(3,'PO0707150003','2015-07-07','SUP0019','Hutang','20995','0','0','30','admin'),(4,'PO0707150004','2015-07-07','SUP0019','Hutang','198900','0','0','30','admin');
...
INSERT INTO `pos_podetail` VALUES (1,'PO0207150001','002','5','127000','0','635000'),(2,'PO0707150002','P 1 BI Gemar Berbahasa Indonesia 1A  ERLANGGA PD P','98','22100','0','2165800'),(3,'PO0707150003','P 1 BI Gemar Berbahasa Indonesia 1A  ERLANGGA PD P','1','22100','5','20995'),(4,'PO0707150004','P 1 BI Gemar Berbahasa Indonesia 1A  ERLANGGA PD P','10','22100','10','198900');

#
# Structure for table "pos_popenjualan"
#
...
#
# Data for table "pos_popenjualan"
#

INSERT INTO `pos_popenjualan` VALUES (1,'POF0207150001','2015-07-02','1005','Pemesanan','110000','0','110000','0','admin'),(2,'POF0207150002','2015-07-02','1005','Pemesanan','30000','0','30000','0','admin');

#
# Structure for table "pos_popenjualandetail"
#
...
#
# Data for table "pos_popenjualandetail"
#

INSERT INTO `pos_popenjualandetail` VALUES (1,'POF0207150001','008','2','55000','50000','0','110000'),(2,'POF0207150002','BK001','1','30000','25000','0','30000');
...
INSERT INTO `pos_produkbiaya` VALUES (2,6,'5','GURU PRAMUKA','GURU PRAMUKA','100000'),(3,3,'5','BTRP01','BIAYA TRANSPORTASI BUKU','1000');
...
INSERT INTO `pos_supplier` VALUES (4,'01','PD. PURNAMA RAYA','CITRALAND SURABAYA','0317344875, 0317344492, FAX 0317385162','Hutang','14 HARI'),(5,'02','NASYWAH.COM','JL. GUBENG KERTAJAYA 7 F / 10 SURABAYA','03177751622, 081703708991','Hutang','14 HARI'),(6,'03','MENTARI BOOKS','JL. DARMO PERMAI SELATAN SURABAYA','02158900818','Hutang','14 HARI'),(7,'04','PENERBIT ERLANGGA','JL. BERBEK INDUSTRI VII / 15 SURABAYA','0318687910-12 FAX 0318687913','Hutang','90 HARI');
...
INSERT INTO `pos_useraura` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','admin@elyon.sch.id','af0675a9e843c6c8f78163a9118efc78.jpg','Administrator','aktif',0,'2015-08-19 15:58:16','2010-08-27 00:00:00','2034-08-27 00:00:00','<p><b>none</b></p>'),(28,'superadmin','b11d5ece6353d17f85c5ad30e0a02360','rekysda@gmail.com','','Administrator','aktif',1,'2015-03-21 23:05:28','0000-00-00 00:00:00','0000-00-00 00:00:00',''),(29,'penjualan','13bf2c8effae21d17a277520aa9b9277','penjualan@penjualan.com','','Penjualan','aktif',0,'2015-06-01 09:03:46','0000-00-00 00:00:00','0000-00-00 00:00:00',''),(30,'kasir','c7911af3adbd12a035b289556d96470a','kasir@kasir.com','','Kasir','aktif',0,'2015-07-07 14:56:07','0000-00-00 00:00:00','0000-00-00 00:00:00',''),(31,'gudang','202446dd1d6028084426867365b0c7a1','gudang@gudang.com','','Gudang','aktif',0,'2015-07-02 12:52:01','0000-00-00 00:00:00','0000-00-00 00:00:00',''),(32,'accounting','d4c143f004d88b7286e6f999dea9d0d7','accounting@accounting.com','','Accounting','aktif',0,'2015-07-07 15:13:00','0000-00-00 00:00:00','0000-00-00 00:00:00','');
