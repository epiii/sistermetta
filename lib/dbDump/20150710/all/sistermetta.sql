...
INSERT INTO `aka_guru` VALUES (20,1,'',2,2,'1',''),(24,1,'',5,1,'1',''),(26,1,'',1,2,'1',''),(28,1,'',6,1,'1','keterangan');
...
#
# Structure for table "aka_kelas_copy1"
#

DROP TABLE IF EXISTS `aka_kelas_copy1`;
CREATE TABLE `aka_kelas_copy1` (
  `replid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `kelas` varchar(100) NOT NULL,
  `tahunajaran` int(10) unsigned NOT NULL,
  `subtingkat` int(10) NOT NULL,
...
#
# Data for table "aka_kelas_copy1"
#
...
INSERT INTO `aka_subtingkat` VALUES (15,'A',3),(17,'1',4),(18,'2',4);
...
CREATE TABLE `aka_tingkat` (
  `replid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `tingkat` varchar(150) DEFAULT NULL,
  `keterangan` text,
...
/*!40000 ALTER TABLE `aka_tingkat` DISABLE KEYS */;
INSERT INTO `aka_tingkat` VALUES (1,'Toddler','Usia 1 - 3 Tahun',1),(2,'Playgroup','Usia 3 Tahun',2),(3,'Kindergarten','Usia 5 Tahun',3),(4,'Primary','Usia 6 Tahun',4);
/*!40000 ALTER TABLE `aka_tingkat` ENABLE KEYS */;

#
# Structure for table "aka_tingkat_copy1"
#

DROP TABLE IF EXISTS `aka_tingkat_copy1`;
CREATE TABLE `aka_tingkat_copy1` (
  `replid` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
#
# Data for table "aka_tingkat_copy1"
#

/*!40000 ALTER TABLE `aka_tingkat_copy1` DISABLE KEYS */;
INSERT INTO `aka_tingkat_copy1` VALUES (1,'Toddler','Usia 1 - 3 Tahun',1),(2,'Playgroup','Usia 3 Tahun',1),(3,'Kindergarten','Usia 5 Tahun',1),(4,'Primary','Usia 6 Tahun',1);
/*!40000 ALTER TABLE `aka_tingkat_copy1` ENABLE KEYS */;
...
INSERT INTO `kon_menu` VALUES (1,1,'Pendataan Siswa','pendataan-siswa','double',1,9,''),(2,1,'Presensi Siswa','presensi-siswa','double',2,10,''),(3,1,'Rapor Siswa','rapor-siswa','double',3,11,''),(4,1,'Pendataan Alumni','pendataan-alumni','double',4,12,''),(5,1,'Pelajaran','pelajaran','double',5,13,''),(6,1,'Guru','guru','double',6,14,''),(7,1,'Jadwal Pelajaran','jadwal-pelajaran','double',7,15,''),(8,5,'Transaksi','transaksi','double',8,16,''),(9,5,'Modul Penerimaan Siswa','modul-penerimaan-siswa','double',9,17,''),(10,5,'Penerimaan Siswa','penerimaan-siswa','double',10,18,''),(11,5,'Inventory','inventory','double',11,19,''),(12,6,'Tahun Buku','tahun-buku','',12,20,''),(13,6,'Saldo Awal','saldo-rekening','',13,13,''),(14,6,'Kategori COA','kategori-rekening','',14,14,''),(15,6,'COA','detil-rekening','',15,19,''),(16,6,'Anggaran','set-anggaran','',16,16,''),(19,7,'Warna','warna','',4,17,''),(20,8,'level','level','',5,16,''),(21,8,'user','user','',7,15,''),(22,7,'Icon','icon','',4,13,''),(23,5,'Pendanaan Aktivitas','pendanaan-aktivitas','double',7,13,'');
...
INSERT INTO `kon_modul` VALUES (1,1,'akademik','akademik',13,9,'double','\n'),(2,1,'psb','penerimaan siswa baru',14,10,'double',''),(3,1,'perpustakaan','perpustakaan',3,11,'double double-vertical',''),(4,1,'sarpras','sarana dan prasarana',4,12,'double double-vertical',''),(5,2,'hrd','kepegawaian',5,13,'double double-vertical',''),(6,2,'keuangan','keuangan',6,14,'double double-vertical',''),(7,2,'student','student services',7,15,'double',''),(8,2,'purchaseorder','purchase order',8,16,'double','');
...
INSERT INTO `po_useraura` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','admin@elyon.sch.id','af0675a9e843c6c8f78163a9118efc78.jpg','Administrator','aktif',0,'2015-06-23 06:50:55','2010-08-27 00:00:00','2034-08-27 00:00:00','<p><b>none</b></p>'),(28,'superadmin','b11d5ece6353d17f85c5ad30e0a02360','rekysda@gmail.com','','Administrator','aktif',1,'2015-03-21 23:05:28','0000-00-00 00:00:00','0000-00-00 00:00:00','');
...
INSERT INTO `pos_customer` VALUES (1,'123','BRYANT','1'),(2,'234','ALEXANDER','1');
...
INSERT INTO `pos_jenisproduk` VALUES (1,'SERAGAM'),(3,'BUKU'),(4,'ATK');
...
INSERT INTO `pos_pembelian` VALUES (7,'INV2603150001','2015-03-26','SUP111','Tunai','490000','0','490000','500000','admin'),(8,'INV2603150002','2015-03-26','SUP0019','Tunai','720000','5000','715000','720000','admin');
...
INSERT INTO `pos_pembeliandetail` VALUES (14,'INV2603150001','KEMEJA PUTRA','2','120000'),(15,'INV2603150001','DASI','5','50000'),(16,'INV2603150002','KEMEJA PUTRA','6','120000');
...
INSERT INTO `pos_pembelianretur` VALUES (3,'RTB2603150002','2015-03-26','SUP111','375000','admin'),(4,'RTB2603150003','2015-03-26','SUP111','115000','admin'),(5,'RTB2603150004','2015-03-26','SUP0019','240000','admin');
...
INSERT INTO `pos_pembelianreturdetail` VALUES (3,'RTB2603150002','BLOUSE PUTRI','1','115000'),(4,'RTB2603150002','JUMPER PUTRI','2','130000'),(5,'RTB2603150003','BLOUSE PUTRI','1','115000'),(6,'RTB2603150004','KEMEJA PUTRA','2','120000');
...
INSERT INTO `pos_produk` VALUES (15,1,'BLOUSE PUTRI','BLOUSE PUTRI ','100','115000','115000'),(16,1,'JUMPER PUTRI','JUMPER PUTRI','126','130000','130000'),(17,1,'KEMEJA PUTRA','KEMEJA PUTRA','412','120000','120000'),(18,1,'CELANA PUTRA','CELANA PUTRA','334','125000','125000'),(19,1,'DASI','DASI','532','50000','50000'),(20,1,'KAOS OR','KAOS OLAH RAGA','786','75000','75000'),(21,1,'CELANA OR','CELANA OLAH RAGA','562','75000','75000'),(22,1,'TOPI','TOPI','402','55000','55000');
...
INSERT INTO `pos_useraura` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','reky@teamworks.co.id','af0675a9e843c6c8f78163a9118efc78.jpg','Administrator','aktif',0,'2015-06-23 06:50:28','2010-08-27 00:00:00','2034-08-27 00:00:00','<p><b>none</b></p>'),(28,'superadmin','b11d5ece6353d17f85c5ad30e0a02360','reky@teamworks.co.id','','Administrator','aktif',1,'2015-03-21 23:05:28','0000-00-00 00:00:00','0000-00-00 00:00:00','');
...
INSERT INTO `psb_calonsiswa_ayah` VALUES (24,25,'','','2015-07-09',0,'','','',0,'','',''),(25,26,'','','0000-00-00',0,'','','',0,'','',''),(26,27,'','','0000-00-00',0,'','','',0,'','',''),(27,28,'Huinto Tin','','0000-00-00',0,'','','',0,'081 75175117','',''),(28,29,'David Teguh Budainto','','0000-00-00',0,'','','',0,'0315340522','',''),(29,30,'Irwanto','','0000-00-00',0,'','','',0,'031. 7318473','',''),(30,31,'Rendy Motanto','','0000-00-00',0,'','','',0,'031. 77556589','',''),(31,32,'Triady Taslim','','0000-00-00',0,'','','',0,'031. 77120122','',''),(32,33,'','','2015-07-16',0,'','','',0,'','',''),(33,34,'','','2015-07-09',0,'','','',0,'','','');
...
INSERT INTO `psb_calonsiswa_kontakdarurat` VALUES (24,25,'','',''),(25,26,'','',''),(26,27,'','',''),(27,28,'','',''),(28,29,'','',''),(29,30,'','',''),(30,31,'','',''),(31,32,'','',''),(32,33,'','',''),(33,34,'','','');
...
#
# Structure for table "psb_kriteria_copy"
#

DROP TABLE IF EXISTS `psb_kriteria_copy`;
CREATE TABLE `psb_kriteria_copy` (
  `replid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `kriteria` int(10) NOT NULL,
...
#
# Data for table "psb_kriteria_copy"
#

INSERT INTO `psb_kriteria_copy` VALUES (1,1,'Tod',1,'Balita 1 tahun',1,'2015-06-02 20:52:51'),(2,2,'PG',1,'PG 1 tahun',2,'2015-06-02 20:53:05'),(3,3,'KG',1,'TK 1 tahun',3,'2015-06-02 20:53:30'),(8,4,'',1,'keterangan ',0,'2015-07-09 01:30:05'),(10,3,'',2,'PG n',0,'2015-07-09 04:00:18'),(11,4,'',2,'',0,'2015-07-09 04:03:28'),(12,2,'',2,'',0,'2015-07-09 04:03:38'),(13,1,'',2,'',0,'2015-07-09 04:03:52');
...
INSERT INTO `psb_setbiaya` VALUES (1,1000000,15000000,500000,1,1,1),(2,1000000,10000000,500000,1,2,1),(3,1000000,20000000,500000,1,3,1),(4,0,90000000,8000000,2,1,1),(5,3000000,0,0,2,2,1),(6,0,0,0,2,3,1),(7,0,0,0,3,1,1),(8,0,0,0,3,2,1),(9,0,0,0,3,3,1),(10,800000,10000000,500000,4,1,1),(11,800000,10000000,500000,4,2,1),(12,800000,10000000,500000,4,3,1),(13,4500000,15000000,2500000,1,1,2),(14,800000,35000000,7000000,1,2,2),(15,7000000,6000000,8000000,1,3,2),(16,2500000,5500000,1500000,2,1,2),(17,15000000,25000000,3500000,2,2,2),(18,15000000,25000000,5500000,2,3,2),(19,1500000,3500000,1700000,3,1,2),(20,0,0,0,3,2,2),(21,0,0,0,3,3,2),(22,0,0,0,4,1,2),(23,0,0,0,4,2,2),(24,0,0,0,4,3,2),(25,1000000,15000000,500000,1,1,3),(26,1000000,10000000,500000,1,2,3),(27,1000000,20000000,500000,1,3,3),(28,8000000,85000000,90000,2,1,3),(29,7000000,0,0,2,2,3),(30,0,0,0,2,3,3),(31,0,0,0,3,1,3),(32,0,0,0,3,2,3),(33,0,0,0,3,3,3),(34,0,0,0,4,1,3),(35,0,0,0,4,2,3),(36,0,0,0,4,3,3),(37,66000000,55000000,660000,1,1,4),(38,2000000,45000000,5500000,1,2,4),(39,5500000,6700000,550000,1,3,4),(40,0,0,0,2,1,4),(41,0,0,0,2,2,4),(42,0,0,0,2,3,4),(43,0,0,0,3,1,4),(44,0,0,0,3,2,4),(45,0,0,0,3,3,4),(46,0,0,0,4,1,4),(47,0,0,0,4,2,4),(48,0,0,0,4,3,4);
...
INSERT INTO `sar_dpeminjaman` VALUES (1,1,2,'2015-07-01',0),(2,1,2,'2015-07-01',0),(3,1,3,'2015-07-01',0);
...
INSERT INTO `sar_katalog` VALUES (1,3,'IT','Monitor',2,0,0,NULL,X'',''),(2,3,'IT','CPU',2,0,0,NULL,X'',''),(3,3,'IT','KEYBOARD DAN MOUSE',2,0,0,NULL,X'',''),(4,2,'ELT','AC',2,0,0,NULL,X'',''),(5,2,'ELT','Speaker',2,0,0,NULL,X'','');
...
INSERT INTO `sar_peminjaman2` VALUES (1,1,'o','2015-07-17','2015-07-10','');
...
INSERT INTO `useraura` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','reky@teamworks.co.id','af0675a9e843c6c8f78163a9118efc78.jpg','Administrator','aktif',1,'2015-07-10 01:01:50','2010-08-27 00:00:00','2034-08-27 00:00:00','<p><b>none</b></p>'),(28,'superadmin','21232f297a57a5a743894a0e4a801fc3','reky@teamworks.co.id','','Administrator','aktif',1,'2015-03-21 23:05:28','0000-00-00 00:00:00','0000-00-00 00:00:00','');
