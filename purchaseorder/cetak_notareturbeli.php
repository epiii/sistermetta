...
echo "<html><head><title>Nota Retur Pembelian </title>";
...
echo'</td></tr><tr><td>';
$no=1;
$query 		= mysql_query ("SELECT * FROM `po_pembelianretur` WHERE `noretur` like '$kode'");
...
$hasild = $koneksi_db->sql_query("SELECT * FROM `po_pembelianreturdetail` WHERE `noretur` like '$kode'");
